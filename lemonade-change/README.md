...
<pre style="position: relative;"><strong>Input: </strong><span id="example-input-1-1">[5,5,5,10,20]</span>
...
<pre style="position: relative;"><strong>Input: </strong><span id="example-input-2-1">[5,5,10]</span>
...
<pre style="position: relative;"><strong>Input: </strong><span id="example-input-3-1">[10,10]</span>
...
<pre style="position: relative;"><strong>Input: </strong><span id="example-input-4-1">[5,5,10,10,20]</span>
