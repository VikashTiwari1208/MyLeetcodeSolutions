<h2>891. Sum of Subsequence Widths</h2><h3>Hard</h3><hr><div><p>The <strong>width</strong> of a sequence is the difference betwee<span class="highlighter--highlighted" style="background-color: yellow;" data-highlight-id="3">n the maximum and minimum elements in the sequence</span>.</p>
